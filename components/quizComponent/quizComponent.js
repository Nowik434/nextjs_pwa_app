            ...
            <Box sx={{ my: 4 }}>
                {showScore ? (
                    <>
                        ...
                        <Button variant="contained" size="large" onClick={(e) => !secondTry ? resetTest(e) : router.push('/')}>{!secondTry ? 'Spróbuj jeszcze raz' : 'Niestety nie udało ci się uzyskać pozytywnego wyniku'}</Button>
...
//                                     Niestety odpowiedziałeś/aś błędnie na większość pytań! Możesz spróbować jeszcze raz!
//                                 </Typography>
//                                 <Button variant="contained" size="large" onClick={(e) => resetTest(e)}>{secondTry ? 'Spróbuj jeszcze raz' : router.push('/')}</Button>
//                             </>
//                         ) : null
//                         }
//                     </>
